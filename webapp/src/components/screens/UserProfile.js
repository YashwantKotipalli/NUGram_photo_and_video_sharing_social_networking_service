       ...
       <div className="home">
           <div className="profileContainer">
               ...
               <div>
                   ...
                   {/* no of likes, followers and following */}
                   ...
                   {showfollow?
                   <button className="btn btn-color m-10"
                    onClick={()=>followUser()}
                    >
                        Follow
                    </button>
